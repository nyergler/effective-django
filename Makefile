...
.PHONY: help clean html dirhtml singlehtml pickle json htmlhelp qthelp devhelp epub latex latexpdf text man changes linkcheck doctest coverage gettext check-syntax push all
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/EffectiveDjango.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/EffectiveDjango.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/EffectiveDjango"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/EffectiveDjango"
	@echo "# devhelp"
